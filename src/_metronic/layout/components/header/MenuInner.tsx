...
import { DeviceWrapper } from '../../../../app/pages/device_management/DeviceWrapper'; 
export function MenuInner() {
  const intl = useIntl()
  return (
    <>
      {/* <MenuItem title={intl.formatMessage({ id: 'MENU.DASHBOARD' })} to='/dashboard' />
      <MenuItem title='Device Management' to='/devicemanagement' /> */}
      ...
      {/* <MenuItem title='Transactions' to='/transactionsSummary' /> */}
