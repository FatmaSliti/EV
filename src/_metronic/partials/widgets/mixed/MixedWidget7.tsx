...
const MixedWidget7: React.FC<Props> = ({ className, chartColor, chartHeight }) => {
  ...
  return (
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 py-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>Battery Status</span>
          <span className='text-muted fw-semibold fs-7'>Charge Completion</span>
        </h3>
      ...
      <div className='card-body d-flex flex-column'>
        ...
        <div className='pt-5'>
          <p className='text-center fs-6 pb-5 '>
            <span className='badge badge-light-danger fs-8'>Notes:</span>&nbsp; Currently at 74% charge level
            <br />
            {/* to approve newly amended policies */}
          </p>
