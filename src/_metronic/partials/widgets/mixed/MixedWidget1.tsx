    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-body p-0'>
        ...
        <div className={`px-9 pt-7 card-rounded h-275px w-100 bg-${color}`}>
          {/* begin::Heading */}
          <div className='d-flex flex-stack'>
            <h3 className='m-0 text-white fw-bold fs-3'>Charger Overview</h3>
            <div className='ms-1'>
              {/* begin::Menu */}
              <button
                type='button'
          ...
          {/* begin::Balance */}
          <div className='d-flex text-center flex-column text-white pt-8'>
            <span className='fw-semibold fs-7'>Total Chargers Installed</span>
            <span className='fw-bold fs-2x pt-1'>500</span>
          </div>
          {/* end::Balance */}
        </div>
        {/* end::Header */}
        ...
        >
          ...
          <div className='d-flex align-items-center mb-6'>
            ...
            <div className='d-flex align-items-center flex-wrap w-100'>
              ...
              {/* begin::Label */}
              <div className='d-flex align-items-center'>
                <div className='fw-bold fs-5 text-gray-800 pe-1'>CHG001</div>
                {/* <KTIcon iconName='arrow-up' className='fs-5 text-success ms-1' /> */}
              </div>
              {/* end::Label */}
            </div>
          ...
          <div className='d-flex align-items-center mb-6'>
            ...
            <div className='d-flex align-items-center flex-wrap w-100'>
              ...
              {/* begin::Label */}
              <div className='d-flex align-items-center'>
                <div className='fw-bold fs-5 text-gray-800 pe-1'>123 Main St</div>
                {/* <KTIcon iconName='arrow-down' className='fs-5 text-danger ms-1' /> */}
              </div>
              {/* end::Label */}
            </div>
          ...
          <div className='d-flex align-items-center mb-6'>
            ...
            <div className='d-flex align-items-center flex-wrap w-100'>
              ...
              {/* begin::Label */}
              <div className='d-flex align-items-center'>
                <div className='fw-bold fs-5 text-gray-800 pe-1'>Online</div>
                {/* <KTIcon iconName='arrow-up' className='fs-5 text-success ms-1' /> */}
              </div>
              {/* end::Label */}
            </div>
          ...
          <div className='d-flex align-items-center'>
            ...
            <div className='d-flex align-items-center flex-wrap w-100'>
              ...
              {/* begin::Label */}
              <div className='d-flex align-items-center'>
                <div className='fw-bold fs-5 text-gray-800 pe-1'>2023-01-08</div>
                {/* <KTIcon iconName='arrow-down' className='fs-5 text-danger ms-1' /> */}
              </div>
              {/* end::Label */}
            </div>
