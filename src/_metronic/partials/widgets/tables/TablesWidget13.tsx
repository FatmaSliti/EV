...
//           <span className='card-label fw-bold fs-3 mb-1'>Chargers</span>
...
//                   </div>
//                 </th>
//                 <th className='min-w-150px'>Charger ID</th>
//                 <th className='min-w-140px'>Location</th>
//                 <th className='min-w-120px'>Status</th>
//                 <th className='min-w-120px'>Type</th>
//                 <th className='min-w-120px'>Power Output (kW)</th>
//                 <th className='min-w-120px'>Usage (kWh)</th>
//                 <th className='min-w-120px'>Network/Provider</th>
          ...
          <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3'>
            ...
            <tbody>
              <tr>
                ...
                <td className='text-dark fw-bold text-hover-primary fs-6'>50</td>
                <td className='text-dark fw-bold text-hover-primary fs-6'>1000</td>
                <td className='text-dark fw-bold text-hover-primary fs-6'>ChargeNet</td>
              ...
              <tr>
                ...
                <td className='text-dark fw-bold text-hover-primary fs-6'>20</td>
                <td className='text-dark fw-bold text-hover-primary fs-6'>500</td>
                <td className='text-dark fw-bold text-hover-primary fs-6'>EV Connect</td>
                <td className='text-end'>
                  <a
                    href='#'
                    className='btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1'
